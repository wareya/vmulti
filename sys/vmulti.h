...
//
    ...
    0x05, 0x0D,                    // USAGE_PAGE (Digitizers)
    0x09, 0x01,                    // USAGE (Digitizer (generic)) (need to use this one to get all monitors)
    0xA1, 0x01,                    // COLLECTION (Application)
    0x85, REPORTID_DIGI,           //   REPORT_ID (Digi)
      0x05, 0x0D,                  //   USAGE_PAGE (Digitizers)
      0x09, 0x20,                  //   USAGE (Stylus)
      0xA1, 0x00,                  //   COLLECTION (Physical)
        // Buttons and states (Tip Switch, Barrel Switch, Eraser, In Range)
        0x09, 0x32,                //     USAGE (In Range)
        0x09, 0x42,                //     USAGE (Tip Switch)
        ...
        0x81, 0x02,                //     INPUT (Data,Var,Abs)
        // X, Y position (0 to 2^31 - 1)
        0x05, 0x01,                //     USAGE_PAGE (Generic Desktop)
        0x09, 0x30,                //     USAGE (X)
        0x09, 0x31,                //     USAGE (Y)
        0x17, 0x00, 0x00, 0x00, 0x00,          //     LOGICAL_MINIMUM (0)
        0x27, 0xFF, 0xFF, 0x00, 0x00,          //     LOGICAL_MAXIMUM (2^16 - 1)
        0x75, 0x10,                //     REPORT_SIZE (16)
        0x95, 0x02,                //     REPORT_COUNT (2)
        0x81, 0x02,                //     INPUT (Data,Var,Abs)
        // Tip Pressure (0 to 32767)
        0x05, 0x0D,                //     USAGE_PAGE (Digitizers)
        ...
        0x95, 0x01,                //     REPORT_COUNT (1)
        0x81, 0x02,                //     INPUT (Data,Var,Abs)
        // Barrel Pressure (0 to 32767)
        0x09, 0x3B,                //     USAGE (Barrel Pressure)
        0x16, 0x00, 0x00,          //     LOGICAL_MINIMUM (0)
        0x26, 0xFF, 0x7F,          //     LOGICAL_MAXIMUM (32767)
        0x75, 0x10,                //     REPORT_SIZE (16)
        0x95, 0x01,                //     REPORT_COUNT (1)
        0x81, 0x02,                //     INPUT (Data,Var,Abs)
        // Tilt X, Tilt Y (-32768 to 32767)
        0x09, 0x3D,                //     USAGE (Tilt X)
        0x09, 0x3E,                //     USAGE (Tilt Y)
